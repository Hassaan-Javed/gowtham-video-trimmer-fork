...
import com.hi.library.ui.seekbar.widgets.CrystalRangeSeekbar;
import com.hi.library.ui.seekbar.widgets.CrystalSeekbar;
import com.hi.library.utils.CompressOption;
import com.hi.library.utils.CustomProgressView;
import com.hi.library.utils.FileUtilKt;
import com.hi.library.utils.LocaleHelper;
import com.hi.library.utils.LogMessage;
import com.hi.library.utils.TrimVideo;
import com.hi.library.utils.TrimVideoOptions;
import com.hi.library.utils.TrimmerUtils;
import com.hi.library.utils.ViewUtil;
...
public class ActVideoTrimmer extends LocalizationActivity {
    ...
    private void trimVideoWithLiTr() {
        ...
        MediaRange mediaRange = new MediaRange(
                ...
                (lastMaxValue - lastMinValue) * 1000000L // duration
        );
        ...
        mediaTransformer.transform(
                /* requestId */ currentId,
                /* inputUri */ Uri.fromFile(new File(filePath.toString())),
                /* outputFile */ outputPath,
                /* targetFormat */ null,
                /* targetVideoTrackFormat */ null,
